...
class WrapperComponent2 extends StatefulWidget {
  final Widget? child;
  final FirebaseApp? appA;
  final FirebaseApp? appB;

  const WrapperComponent2({super.key, this.child, this.appA, this.appB});

  @override
  State<WrapperComponent2> createState() => _WrapperComponent2State();
}

class _WrapperComponent2State extends State<WrapperComponent2> {
  bool showMenu = false;
                              ...
                              Column(
                                children: [
                                  ...
                                  ListTile(
                                    ...
                                    onTap: () {
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (_) => BackgroundLocationAdminScreen(app: widget.appB??Firebase.app(),)));
                                    },
                                  ),
                                  ListTile(
                                    contentPadding: EdgeInsets.zero,
                                  ...
                                  ListTile(
                                    ...
                                    title: Text('Routing ADMIN PANEL'),
                                    textColor: Colors.white,
                                    onTap: () {
                            ...
                            if (!isDesktop)
                              Row(
                                children: [
                                  ...
                                  Text(
                                    'Background Location Admin Panel',
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 24,
